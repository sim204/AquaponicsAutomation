...
class AdjustWaterLevel(Command):
    ...
    def __init__(self,waterLevel):
        ...
        self.maxWater=20    #Est la valeur maximale que l'aquarium peut contenir en pouces
    ...
    def initialise(self):
        ...
        self.deltaTemps=self.maxWater - self.waterLevel.getVolume()/(100/60)    #Le temps nécessaire pour remplir l'eau au niveau max
    ...
    def isFinish(self):
        return (self.waterLevel.getLevel() < self.maxWater) or (time.time() > (self.tempsInitial + self.deltaTemps))
